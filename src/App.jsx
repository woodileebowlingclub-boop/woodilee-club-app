...
export default function App() {
  ...
  const filteredMembers = useMemo(() => {
    ...
    return members.filter((member) => {
      ...
      const phone = safeString(getField(member, ["phone", "mobile", "phone_number"])).toLowerCase();
      const email = safeString(getField(member, ["email"])).toLowerCase();
      return (
                ...
                {groupItems.length === 0 ? (
                  ...
                  groupItems.map((member) => (
                    <div key={member.id} style={styles.listItem}>
                      ...
                      {getField(member, ["phone", "mobile", "phone_number"]) && (
                        <div style={styles.listMeta}>
                          Phone: {getField(member, ["phone", "mobile", "phone_number"])}
                        </div>
                      )}
                      ...
                      <div style={styles.actionRow}>
                        <WhatsAppButton phone={getField(member, ["phone", "mobile", "phone_number"], "")} />
                        {isAdmin && (
              ...
              officeBearers
                ...
                .map((item) => (
                  <div key={item.id} style={styles.listItem}>
                    ...
                    {getField(item, ["phone", "mobile", "phone_number"]) && (
                      <div style={styles.listMeta}>
                        Phone: {getField(item, ["phone", "mobile", "phone_number"])}
                      </div>
                    )}
                    {getField(item, ["email"]) && (
                    ...
                    <div style={styles.actionRow}>
                      <WhatsAppButton phone={getField(item, ["phone", "mobile", "phone_number"], "")} />
                      {isAdmin && (
                        <button
            ...
            {coaches.length === 0 ? (
              ...
              coaches.map((coach) => (
                <div key={coach.id} style={styles.listItem}>
                  ...
                  {getField(coach, ["phone", "mobile", "phone_number"]) && (
                    <div style={styles.listMeta}>
                      Phone: {getField(coach, ["phone", "mobile", "phone_number"])}
                    </div>
                  )}
                  ...
                  <div style={styles.actionRow}>
                    <WhatsAppButton phone={getField(coach, ["phone", "mobile", "phone_number"], "")} />
                    {isAdmin && (
